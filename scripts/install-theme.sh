...
/tmp/Colloid-gtk-theme/install.sh -c dark -t yellow -l --tweaks gruvbox normal
rm -rf /tmp/Colloid-gtk-theme
gsettings set org.gnome.desktop.interface gtk-theme "Colloid-Yellow-Dark-Gruvbox"
